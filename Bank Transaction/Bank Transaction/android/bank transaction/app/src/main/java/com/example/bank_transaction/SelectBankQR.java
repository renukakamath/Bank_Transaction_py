...
public class SelectBankQR extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_bank_qr);
        ...
        JR.json_response = (JsonResponse) SelectBankQR.this;
...
//                    Toast.makeText(getApplicationContext(), "test", Toast.LENGTH_LONG).show();
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SelectBankQR.this);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items[item].equals("Proceed")) {
                    ...
                    startActivity(new Intent(getApplicationContext(),MoneyTransferWithQR.class));
