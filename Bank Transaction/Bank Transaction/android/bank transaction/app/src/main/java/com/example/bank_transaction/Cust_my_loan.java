...
public class Cust_my_loan extends ArrayAdapter<String>  {
    ...
    public Cust_my_loan(Activity context, String[] loan, String[] details, String[] intrest_name, String[] max_amount, String[] sts) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_cust_my_loan,loan);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_cust_my_loan, null, true);
